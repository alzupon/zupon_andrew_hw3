...
LSTM_student.save("models/model_epochs="+str(num_epochs)+"_irish="+str(num_irish)+"_student_bi")
...
dy.save("models/model_epochs="+str(num_epochs)+"_irish="+str(num_irish)+"_teacher_weighted_bi", [W, b, embedding_parameters, LSTM_unit])


W = LSTM_student.parameters_from_numpy(W_T2[-1])

##### S A V E   T E A C H E R   E M A   M O D E L #####
dy.save("models/model_epochs="+str(num_epochs)+"_irish="+str(num_irish)+"_teacher_EMA_bi", [W, b, embedding_parameters, LSTM_unit])
